...
def get_parser():
    ...
    parser.add_argument('--model', type=str, choices=['DiagSheaf', 'BundleSheaf', 'GeneralSheaf', 'DiagSheafODE',
                                                      'BundleSheafODE', 'GeneralSheafODE','DiagSheafReal', 'BundleSheafReal', 'GeneralSheafReal',], default=None)
    ...
    parser.add_argument("--complex_separate_linears", dest='complex_separate_linears', type=str2bool, default=False,)
    parser.add_argument("--complex_separate_dropout", dest='complex_separate_dropout', type=str2bool, default=True, )
    parser.add_argument("--complex_add_block_diag", dest='complex_add_block_diag', type=str2bool, default=True, )
    parser.add_argument("--complex_copy_values", dest='complex_copy_values', type=str2bool, default=True, )
    parser.add_argument("--complex_q", type=float, default=0.25 )

    parser.add_argument('--trainable_q', dest='trainable_q', type=str2bool, default=False,)

    parser.add_argument("--complex_activation", type=str, choices=['relu', 'elu'], default='relu' )
    parser.add_argument("--complex_use_intro_act", dest='complex_use_intro_act', type=str2bool, default=True, )
    parser.add_argument("--complex_x_dropout", type=float, default=0.0)
    parser.add_argument("--complex_start", dest='complex_start', type=str2bool, default=True, )


    parser.add_argument('--synthetic', help='use of the synthetic dataset', type=str2bool, default=False)

    parser.add_argument('--pred_task', type=str, choices=['node_classification', 'link_prediction'],
                        default='node_classification', help="task type")
    ...
    parser.add_argument('--task', type=int, default=2, help='2: direction and 3-class 1: existance')
