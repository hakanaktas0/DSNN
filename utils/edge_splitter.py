# THIS FILE IS TAKEN FROM https://github.com/stellargraph/stellargraph/blob/develop/stellargraph/data/edge_splitter.py to get rid of the Stellargraph dependency.
...
class EdgeSplitter(object):
    ...
    def __init__(self, g, g_master=None):
        ...
        self._input_was_stellargraph = False
    ...
    def train_test_split(
        ...
        if self._input_was_stellargraph:
            ...
            result_graph = self.g_train # INVALID
        else:
    ...
    def _sample_negative_examples_by_edge_type_global(
        ...
        if len(sampled_edges) != num_edges_to_sample:
            raise ValueError("Unable to sample {} negative edges. Consider using smaller value for p.".format(num_edges_to_sample))
