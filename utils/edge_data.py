...
# Taken from https://github.com/matthew-hirn/magnet/blob/main/src/utils/edge_data.py
...
def generate_dataset_3class(edge_index, size, splits = 10, probs = [0.20, 0.35], task = 2, label_dim = 2):
    ...
    def iteration(ind):
        ...
        G_val, ids_val, _ = edge_splitter_val.train_test_split(p=float(probs[1]), method="global", keep_connected=False, seed = ind)
